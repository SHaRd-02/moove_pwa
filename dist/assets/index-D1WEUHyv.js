 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zo=()=>Qo().__FIREBASE_DEFAULTS__,ea=()=>{if(typeof process>"u"||typeof Ar>"u")return;const i=Ar.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},ta=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&gs(i[1]);return e&&JSON.parse(e)},si=()=>{try{return qo()||Zo()||ea()||ta()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},ms=i=>{var e,n;return(n=(e=si())===null||e===void 0?void 0:e.emulatorHosts)===null||n===void 0?void 0:n[i]},na=i=>{const e=ms(i);if(!e)return;const n=e.lastIndexOf(":");if(n<=0||n+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const r=parseInt(e.substring(n+1),10);return e[0]==="["?[e.substring(1,n-1),r]:[e.substring(0,n),r]},vs=()=>{var i;return(i=si())===null||i===void 0?void 0:i.config},ys=i=>{var e;return(e=si())===null||e===void 0?void 0:e[`_${i}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fa{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(ja(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function ja(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Kn="@firebase/app",Rr="0.11.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xe=dc;function ws(i,e={}){let n=i;typeof e!="object"&&(e={name:e});const r=Object.assign({name:qn,automaticDataCollectionEnabled:!1},e),o=r.name;if(typeof o!="string"||!o)throw Se.create("bad-app-name",{appName:String(o)});if(n||(n=vs()),!n)throw Se.create("no-options");const c=Yt.get(o);if(c){if(Me(n,c.options)&&Me(r,c.config))return c;throw Se.create("duplicate-app",{appName:o})}const h=new Ea(o);for(const w of Jn.values())h.addComponent(w);const y=new mc(n,r,h);return Yt.set(o,y),y}function Es(i=qn){const e=Yt.get(i);if(!e&&i===qn&&vs())return ws();if(!e)throw Se.create("no-app",{appName:i});return e}function Ce(i,e,n){var r;let o=(r=fc[i])!==null&&r!==void 0?r:i;n&&(o+=`-${n}`);const c=o.match(/\s|\//),h=e.match(/\s|\//);if(c||h){const y=[`Unable to register library "${o}" with version "${e}":`];c&&y.push(`library name "${o}" contains illegal characters (whitespace or "/")`),c&&h&&y.push("and"),h&&y.push(`version name "${e}" contains illegal characters (whitespace or "/")`),pe.warn(y.join(" "));return}Ge(new Ue(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vc="firebase-heartbeat-database",yc=1,It="firebase-heartbeat-store";let Bn=null;function Ts(){return Bn||(Bn=Ma(vc,yc,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(It)}catch(n){console.warn(n)}}}}).catch(i=>{throw Se.create("idb-open",{originalErrorMessage:i.message})})),Bn}async function _c(i){try{const n=(await Ts()).transaction(It),r=await n.objectStore(It).get(bs(i));return await n.done,r}catch(e){if(e instanceof me)pe.warn(e.message);else{const n=Se.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});pe.warn(n.message)}}}async function Dr(i,e){try{const r=(await Ts()).transaction(It,"readwrite");await r.objectStore(It).put(e,bs(i)),await r.done}catch(n){if(n instanceof me)pe.warn(n.message);else{const r=Se.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});pe.warn(r.message)}}}function bs(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sc(i){Ge(new Ue("platform-logger",e=>new Fa(e),"PRIVATE")),Ge(new Ue("heartbeat",e=>new Ec(e),"PRIVATE")),Ce(Kn,Rr,i),Ce(Kn,Rr,"esm2017"),Ce("fire-js","")}Sc("");var Cc="firebase",kc="11.6.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ce(Cc,kc,"app");function li(i,e){var n={};for(var r in i)Object.prototype.hasOwnProperty.call(i,r)&&e.indexOf(r)<0&&(n[r]=i[r]);if(i!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,r=Object.getOwnPropertySymbols(i);o<r.length;o++)e.indexOf(r[o])<0&&Object.prototype.propertyIsEnumerable.call(i,r[o])&&(n[r[o]]=i[r[o]]);return n}function As(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Pc=As,Ss=new Et("auth","Firebase",As());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xn(){var i;return typeof self<"u"&&((i=self.location)===null||i===void 0?void 0:i.href)||""}function Dc(){return Mr()==="http:"||Mr()==="https:"}function Mr(){var i;return typeof self<"u"&&((i=self.location)===null||i===void 0?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(i){if(i)try{const e=new Date(Number(i));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Vc(i,e=!1){const n=Je(i),r=await n.getIdToken(e),o=pi(r);b(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const c=typeof o.firebase=="object"?o.firebase:void 0,h=c==null?void 0:c.sign_in_provider;return{claims:o,token:r,authTime:gt(Vn(o.auth_time)),issuedAtTime:gt(Vn(o.iat)),expirationTime:gt(Vn(o.exp)),signInProvider:h||null,signInSecondFactor:(c==null?void 0:c.sign_in_second_factor)||null}}function Vn(i){return Number(i)*1e3}function pi(i){const[e,n,r]=i.split(".");if(e===void 0||n===void 0||r===void 0)return Gt("JWT malformed, contained fewer than 3 sections"),null;try{const o=gs(n);return o?JSON.parse(o):(Gt("Failed to decode base64 JWT payload"),null)}catch(o){return Gt("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function Ur(i){const e=pi(i);return b(e,"internal-error"),b(typeof e.exp<"u","internal-error"),b(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gc(i,e){const n=await ks(i,{},async()=>{const r=Tt({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:o,apiKey:c}=i.config,h=await Ps(i,o,"/v1/token",`key=${c}`),y=await i._getAdditionalHeaders();return y["Content-Type"]="application/x-www-form-urlencoded",Cs.fetch()(h,{method:"POST",headers:y,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Kc(i,e){return Ye(i,"POST","/v2/accounts:revokeToken",fi(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xr=new Map;function fe(i){ge(i instanceof Function,"Expected a class definition");let e=xr.get(i);return e?(ge(e instanceof i,"Instance stored in cache mismatched with class"),e):(e=new i,xr.set(i,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Os{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Os.type="NONE";const Fr=Os;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jr(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ms(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ds(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(xs(e))return"Blackberry";if(Fs(e))return"Webos";if(Ns(e))return"Safari";if((e.includes("chrome/")||Ls(e))&&!e.includes("edge/"))return"Chrome";if(Us(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=i.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Ds(i=K()){return/firefox\//i.test(i)}function Ns(i=K()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ls(i=K()){return/crios\//i.test(i)}function Ms(i=K()){return/iemobile/i.test(i)}function Us(i=K()){return/android/i.test(i)}function xs(i=K()){return/blackberry/i.test(i)}function Fs(i=K()){return/webos/i.test(i)}function gi(i=K()){return/iphone|ipad|ipod/i.test(i)||/macintosh/i.test(i)&&/mobile/i.test(i)}function qc(i=K()){var e;return gi(i)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Jc(){return la()&&document.documentMode===10}function js(i=K()){return gi(i)||Us(i)||Fs(i)||xs(i)||/windows phone/i.test(i)||Ms(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bs(i,e=[]){let n;switch(i){case"Browser":n=jr(K());break;case"Worker":n=`${jr(K())}-${i}`;break;default:n=i}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Xe}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sl(i,e){const n=ci(i,"auth");if(n.isInitialized()){const o=n.getImmediate(),c=n.getOptions();if(Me(c,e??{}))return o;oe(o,"already-initialized")}return n.initialize({options:e})}function ol(i,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(fe);e!=null&&e.errorMap&&i._updateErrorMap(e.errorMap),i._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function al(i,e,n){const r=an(i);b(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const o=!1,c=Vs(e),{host:h,port:y}=cl(e),w=y===null?"":`:${y}`,E={url:`${c}//${h}${w}/`},A=Object.freeze({host:h,port:y,protocol:c.replace(":",""),options:Object.freeze({disableWarnings:o})});if(!r._canInitEmulator){b(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),b(Me(E,r.config.emulator)&&Me(A,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=E,r.emulatorConfig=A,r.settings.appVerificationDisabledForTesting=!0,ll()}function Vs(i){const e=i.indexOf(":");return e<0?"":i.substr(0,e+1)}function cl(i){const e=Vs(i),n=/(\/\/)?([^?#/]+)/.exec(i.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",o=/^(\[[^\]]+\])(:|$)/.exec(r);if(o){const c=o[1];return{host:c,port:Vr(r.substr(c.length+1))}}else{const[c,h]=r.split(":");return{host:c,port:Vr(h)}}}function Vr(i){if(!i)return null;const e=Number(i);return isNaN(e)?null:e}function ll(){function i(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",i):i())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hs{constructor(e,n){this.providerId=e,this.signInMethod=n}toJSON(){return de("not implemented")}_getIdTokenResponse(e){return de("not implemented")}_linkToIdToken(e,n){return de("not implemented")}_getReauthenticationResolver(e){return de("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dl(i,e,n=!1){const{auth:r}=i;if(te(r.app))return Promise.reject(Le(r));const o="reauthenticate";try{const c=await wt(i,$s(r,o,e,i),n);b(c.idToken,r,"internal-error");const h=pi(c.idToken);b(h,r,"internal-error");const{sub:y}=h;return b(i.uid===y,r,"user-mismatch"),Ke._forOperation(i,o,c)}catch(c){throw(c==null?void 0:c.code)==="auth/user-not-found"&&oe(r,"user-mismatch"),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(nn,"1"),this.storage.removeItem(nn),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gs extends zs{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}Gs.type="SESSION";const Ks=Gs;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qs(){return typeof se().WorkerGlobalScope<"u"&&typeof se().importScripts=="function"}async function El(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Tl(){var i;return((i=navigator==null?void 0:navigator.serviceWorker)===null||i===void 0?void 0:i.controller)||null}function bl(){return qs()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qs(i,e){return e?fe(e):(b(i._popupRedirectResolver,i,"argument-error"),i._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $l=10*60*1e3;class zl{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(n=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!Wl(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var r;if(e.error&&!eo(e)){const o=((r=e.error.code)===null||r===void 0?void 0:r.split("auth/")[1])||"internal-error";n.onError(re(this.auth,o))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const r=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=$l&&this.cachedEventUids.clear(),this.cachedEventUids.has(Wr(e))}saveEventToCache(e){this.cachedEventUids.add(Wr(e)),this.lastProcessedEventTime=Date.now()}}function Wr(i){return[i.type,i.eventId,i.sessionId,i.tenantId].filter(e=>e).join("-")}function eo({type:i,error:e}){return i==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function Wl(i){switch(i.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return eo(i);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yl=new bt(3e4,6e4);function Gr(){const i=se().___jsl;if(i!=null&&i.H){for(const e of Object.keys(i.H))if(i.H[e].r=i.H[e].r||[],i.H[e].L=i.H[e].L||[],i.H[e].r=[...i.H[e].L],i.CP)for(let n=0;n<i.CP.length;n++)i.CP[n]=null}}function Ql(i){return new Promise((e,n)=>{var r,o,c;function h(){Gr(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Gr(),n(re(i,"network-request-failed"))},timeout:Yl.get()})}if(!((o=(r=se().gapi)===null||r===void 0?void 0:r.iframes)===null||o===void 0)&&o.Iframe)e(gapi.iframes.getContext());else if(!((c=se().gapi)===null||c===void 0)&&c.load)h();else{const y=rl("iframefcb");return se()[y]=()=>{gapi.load?h():n(re(i,"network-request-failed"))},nl(`${il()}?onload=${y}`).catch(w=>n(w))}}).catch(e=>{throw Jt=null,e})}let Jt=null;function Zl(i){return Jt=Jt||Ql(i),Jt}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ah={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},ch=500,lh=600,hh="_blank",uh="http://localhost";class Kr{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function dh(i,e,n,r=ch,o=lh){const c=Math.max((window.screen.availHeight-o)/2,0).toString(),h=Math.max((window.screen.availWidth-r)/2,0).toString();let y="";const w=Object.assign(Object.assign({},ah),{width:r.toString(),height:o.toString(),top:c,left:h}),E=K().toLowerCase();n&&(y=Ls(E)?hh:n),Ds(E)&&(e=e||uh,w.scrollbars="yes");const A=Object.entries(w).reduce((C,[x,P])=>`${C}${x}=${P},`,"");if(qc(E)&&y!=="_self")return fh(e||"",y),new Kr(null);const S=window.open(e||"",y,A);b(S,i,"popup-blocked");try{S.focus()}catch{}return new Kr(S)}function fh(i,e){const n=document.createElement("a");n.href=i,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wh(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Eh(i){Ge(new Ue("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),c=e.getProvider("app-check-internal"),{apiKey:h,authDomain:y}=r.options;b(h&&!h.includes(":"),"invalid-api-key",{appName:r.name});const w={apiKey:h,authDomain:y,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Bs(i)},E=new el(r,o,c,w);return ol(E,n),E},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Ge(new Ue("auth-internal",e=>{const n=an(e.getProvider("auth").getImmediate());return(r=>new Ih(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Ce(Jr,Xr,wh(i)),Ce(Jr,Xr,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Th=5*60,bh=ys("authIdTokenMaxAge")||Th;let Yr=null;const Ah=i=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>bh)return;const o=n==null?void 0:n.token;Yr!==o&&(Yr=o,await fetch(i,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function Sh(i=Es()){const e=ci(i,"auth");if(e.isInitialized())return e.getImmediate();const n=sl(i,{popupRedirectResolver:_h,persistence:[Rl,yl,Ks]}),r=ys("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const c=new URL(r,location.origin);if(location.origin===c.origin){const h=Ah(c.toString());gl(n,h,()=>h(n.currentUser)),pl(n,y=>h(y))}}const o=ms("auth");return o&&al(n,`http://${o}`),n}function Ch(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}tl({loadJS(i){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",i),r.onload=e,r.onerror=o=>{const c=re("internal-error");c.customData=o,n(c)},r.type="text/javascript",r.charset="UTF-8",Ch().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Eh("Browser");var Qr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qe=new oi("@firebase/firestore");function ie(i,...e){if(qe.logLevel<=O.DEBUG){const n=e.map(Ii);qe.debug(`Firestore (${Ct}): ${i}`,...n)}}function no(i,...e){if(qe.logLevel<=O.ERROR){const n=e.map(Ii);qe.error(`Firestore (${Ct}): ${i}`,...n)}}function kh(i,...e){if(qe.logLevel<=O.WARN){const n=e.map(Ii);qe.warn(`Firestore (${Ct}): ${i}`,...n)}}function Ii(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wi(i="Unexpected state"){const e=`FIRESTORE (${Ct}) INTERNAL ASSERTION FAILED: `+i;throw no(e),new Error(e)}function mt(i,e){i||wi()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class io{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Ph{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(G.UNAUTHENTICATED))}shutdown(){}}class Rh{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class Oh{constructor(e){this.t=e,this.currentUser=G.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){mt(this.o===void 0);let r=this.i;const o=w=>this.i!==r?(r=this.i,n(w)):Promise.resolve();let c=new vt;this.o=()=>{this.i++,this.currentUser=this.u(),c.resolve(),c=new vt,e.enqueueRetryable(()=>o(this.currentUser))};const h=()=>{const w=c;e.enqueueRetryable(async()=>{await w.promise,await o(this.currentUser)})},y=w=>{ie("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=w,this.o&&(this.auth.addAuthTokenListener(this.o),h())};this.t.onInit(w=>y(w)),setTimeout(()=>{if(!this.auth){const w=this.t.getImmediate({optional:!0});w?y(w):(ie("FirebaseAuthCredentialsProvider","Auth not yet detected"),c.resolve(),c=new vt)}},0),h()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(ie("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(mt(typeof r.accessToken=="string"),new io(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return mt(e===null||typeof e=="string"),new G(e)}}class Dh{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=G.FIRST_PARTY,this.T=new Map}I(){return this.P?this.P():null}get headers(){this.T.set("X-Goog-AuthUser",this.l);const e=this.I();return e&&this.T.set("Authorization",e),this.h&&this.T.set("X-Goog-Iam-Authorization-Token",this.h),this.T}}class Nh{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new Dh(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(G.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class ts{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Lh{constructor(e,n){this.A=n,this.forceRefresh=!1,this.appCheck=null,this.R=null,this.V=null,te(e)&&e.settings.appCheckToken&&(this.V=e.settings.appCheckToken)}start(e,n){mt(this.o===void 0);const r=c=>{c.error!=null&&ie("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${c.error.message}`);const h=c.token!==this.R;return this.R=c.token,ie("FirebaseAppCheckTokenProvider",`Received ${h?"new":"existing"} token.`),h?n(c.token):Promise.resolve()};this.o=c=>{e.enqueueRetryable(()=>r(c))};const o=c=>{ie("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=c,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(c=>o(c)),setTimeout(()=>{if(!this.appCheck){const c=this.A.getImmediate({optional:!0});c?o(c):ie("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.V)return Promise.resolve(new ts(this.V));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(mt(typeof n.token=="string"),this.R=n.token,new ts(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}function Mh(i){return i.name==="IndexedDbTransactionError"}const Zn="(default)";class sn{constructor(e,n){this.projectId=e,this.database=n||Zn}static empty(){return new sn("","")}get isDefaultDatabase(){return this.database===Zn}isEqual(e){return e instanceof sn&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new to([4294967295,4294967295],0);/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cs="AsyncQueue";class ls{constructor(e=Promise.resolve()){this.Vu=[],this.mu=!1,this.fu=[],this.gu=null,this.pu=!1,this.yu=!1,this.wu=[],this.a_=new Fh(this,"async_queue_retry"),this.Su=()=>{const r=$n();r&&ie(cs,"Visibility state changed to "+r.visibilityState),this.a_.t_()},this.bu=e;const n=$n();n&&typeof n.addEventListener=="function"&&n.addEventListener("visibilitychange",this.Su)}get isShuttingDown(){return this.mu}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.Du(),this.vu(e)}enterRestrictedMode(e){if(!this.mu){this.mu=!0,this.yu=e||!1;const n=$n();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this.Su)}}enqueue(e){if(this.Du(),this.mu)return new Promise(()=>{});const n=new vt;return this.vu(()=>this.mu&&this.yu?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Vu.push(e),this.Cu()))}async Cu(){if(this.Vu.length!==0){try{await this.Vu[0](),this.Vu.shift(),this.a_.reset()}catch(e){if(!Mh(e))throw e;ie(cs,"Operation failed with retryable error: "+e)}this.Vu.length>0&&this.a_.Xo(()=>this.Cu())}}vu(e){const n=this.bu.then(()=>(this.pu=!0,e().catch(r=>{this.gu=r,this.pu=!1;const o=function(h){let y=h.message||"";return h.stack&&(y=h.stack.includes(h.message)?h.stack:h.message+`
`+h.stack),y}(r);throw no("INTERNAL UNHANDLED ERROR: ",o),r}).then(r=>(this.pu=!1,r))));return this.bu=n,n}enqueueAfterDelay(e,n,r){this.Du(),this.wu.indexOf(e)>-1&&(n=0);const o=Ei.createAndSchedule(this,e,n,r,c=>this.Fu(c));return this.fu.push(o),o}Du(){this.gu&&wi()}verifyOperationInProgress(){}async Mu(){let e;do e=this.bu,await e;while(e!==this.bu)}xu(e){for(const n of this.fu)if(n.timerId===e)return!0;return!1}Ou(e){return this.Mu().then(()=>{this.fu.sort((n,r)=>n.targetTimeMs-r.targetTimeMs);for(const n of this.fu)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.Mu()})}Nu(e){this.wu.push(e)}Fu(e){const n=this.fu.indexOf(e);this.fu.splice(n,1)}}class zh extends so{constructor(e,n,r,o){super(e,n,r,o),this.type="firestore",this._queue=new ls,this._persistenceKey=(o==null?void 0:o.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new ls(e),this._firestoreClient=void 0,await e}}}function Wh(i,e){const n=typeof i=="object"?i:Es(),r=typeof i=="string"?i:Zn,o=ci(n,"firestore").getImmediate({identifier:r});if(!o._initialized){const c=na("firestore");c&&$h(o,...c)}return o}(function(e,n=!0){(function(o){Ct=o})(Xe),Ge(new Ue("firestore",(r,{instanceIdentifier:o,options:c})=>{const h=r.getProvider("app").getImmediate(),y=new zh(new Oh(r.getProvider("auth-internal")),new Lh(h,r.getProvider("app-check-internal")),function(E,A){if(!Object.prototype.hasOwnProperty.apply(E.options,["projectId"]))throw new X(J.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new sn(E.options.projectId,A)}(h,o),h);return c=Object.assign({useFetchStreams:n},c),y._setSettings(c),y},"PUBLIC").setMultipleInstances(!0)),Ce(Zr,es,e),Ce(Zr,es,"esm2017")})();const Gh={apiKey:"AIzaSyCR6xXBhiIeH00S59-27zJsmcOLIt9JCWQ",authDomain:"mooove-pwa.firebaseapp.com",projectId:"mooove-pwa",storageBucket:"mooove-pwa.firebasestorage.app",messagingSenderId:"67182474532",appId:"1:67182474532:web:de9f1b7cd67d23a8b46fb1"},oo=ws(Gh),ao=Sh(oo);Wh(oo);const Kh=new ue,qh=()=>Ml(ao,Kh).then(i=>i.user).catch(i=>{const e=i.code,n=i.message;throw console.error(e,n),i}),Jh=document.getElementById("search-section-btn"),Xh=document.getElementById("favorites-section-btn"),Yh=document.getElementById("account-section-btn"),Qh=document.getElementById("account-section"),Zh=document.getElementById("favorites-section"),eu=document.getElementById("search-section"),tu=document.getElementById("select-route"),nu=document.getElementById("select-route-btn"),hs=document.getElementById("route-origin"),us=document.getElementById("route-destiny"),ds=document.getElementById("tarif-price"),ei=document.getElementById("route-eta"),yt=document.getElementById("start-trip-btn"),iu=document.getElementById("user-card-img"),ru=document.getElementById("user-card-name"),su=document.getElementById("user-card-middle-name"),ou=document.getElementById("user-card-lastname");function Ti(i){document.querySelectorAll(".sections").forEach(n=>n.classList.add("hidden")),i.classList.remove("hidden")}const au="#BD93F9",cu="#F8F8F2",lu="#282A36",hu="#44475A",uu="#6272A4",du="#4a69c6";let _t,ti,ni,zn=null;const co=14;let on;function bi(i){const e=i.displayName.split(" "),n=e[0],r=e[1],o=e[2];ru.value=n,su.value=r,ou.value=o,iu.src=i.photoURL}const ii=sessionStorage.getItem("user");ii&&(on=JSON.parse(ii),bi(on));window.initMap=function(i,e){_t=new google.maps.Map(document.getElementById("map"),{center:{lat:i,lng:e},zoom:co,disableDefaultUI:!0,styles:[{elementType:"geometry",stylers:[{color:hu}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:cu}]},{elementType:"labels.text.stroke",stylers:[{color:lu}]},{featureType:"administrative",elementType:"geometry",stylers:[{visibility:"off"}]},{featureType:"poi",elementType:"geometry",stylers:[{visibility:"off"}]},{featureType:"road",elementType:"geometry",stylers:[{color:uu}]},{featureType:"water",elementType:"geometry",stylers:[{color:du}]}]}),ti=new google.maps.DirectionsService,ni=new google.maps.DirectionsRenderer({map:_t,suppressMarkers:!1,polylineOptions:{strokeColor:au,strokeWeight:5}})};function fu(){navigator.geolocation?navigator.geolocation.getCurrentPosition(pu,gu):alert("Browser not supported")}function pu(i){const e=i.coords.latitude,n=i.coords.longitude;console.log("Latitude: ",e),console.log("Longitude: ",n),initMap(e,n)}function gu(){alert("Sorry, no position available.")}async function mu(){const i=await Notification.requestPermission();console.log(i==="granted"?"Permiso para notificaciones concedido.":"Permiso denegado.")}mu();async function vu(){const e=await(await navigator.serviceWorker.ready).pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:"BBswnwYK1ainOyoSKM-kQ6Dx7-rz35pItXaKp-N_OQoRAjjl040Jax0nYE4qJDBMcdYAhIHGlcBY3OTj27Za61A"});console.log("Suscripción:",JSON.stringify(e))}vu();document.addEventListener("DOMContentLoaded",fu);function yu(){qh().then(i=>{console.log("Usuario autenticado:",i);const e=ao.currentUser;e?(console.log("Usuario autenticado:",e),console.log("Email:",e.email),console.log("UID:",e.uid),console.log("Nombre:",e.displayName),console.log("Foto de perfil:",e.photoURL),sessionStorage.setItem("user",JSON.stringify({uid:e.uid,email:e.email,displayName:e.displayName,photoURL:e.photoURL})),on=JSON.parse(ii),bi(on),alert("info loaded")):console.log("No hay un usuario autenticado")}).catch(i=>{console.error("Error de autenticación:",i)})}Yh.addEventListener("click",()=>{Ti(Qh),bi(user)});Xh.addEventListener("click",()=>{Ti(Zh)});Jh.addEventListener("click",()=>{Ti(eu)});let ri=[];nu.addEventListener("click",()=>{const i=tu.value;i==="1"?(yt.disabled=!1,hs.innerText="5 y 10",us.innerText="UABC Valle",ds.innerText="$20",ti.route({origin:Tr[0],destination:Tr[1],waypoints:Ko,travelMode:google.maps.TravelMode.DRIVING,optimizeWaypoints:!1},(e,n)=>{if(n==="OK"){ni.setDirections(e),ri=e.routes[0].overview_path;const r=e.routes[0].legs.reduce((c,h)=>c+h.duration.value,0),o=Math.ceil(r/60);ei.innerText=`${o} minutos`}else alert("Error al generar la ruta: "+n)})):i==="2"&&(yt.disabled=!1,hs.innerText="Refugio",us.innerText="UABC Valle",ds.innerText="$20",ti.route({origin:br[0],destination:br[1],travelMode:google.maps.TravelMode.DRIVING,optimizeWaypoints:!1},(e,n)=>{if(n==="OK"){ni.setDirections(e),ri=e.routes[0].overview_path;const r=e.routes[0].legs.reduce((c,h)=>c+h.duration.value,0),o=Math.ceil(r/60);ei.innerText=`${o} minutos`}else alert("Error al generar la ruta: "+n)}))});yt.addEventListener("click",()=>{navigator.geolocation?navigator.geolocation.getCurrentPosition(i=>{const e=new google.maps.LatLng(i.coords.latitude,i.coords.longitude),n=20/111320;google.maps.geometry.poly.isLocationOnEdge(e,new google.maps.Polyline({path:ri}),n)?(yt.disabled=!0,yt.innerText="Viaje en curso...",ei.style.color="rgb(15, 203, 15)",navigator.geolocation.watchPosition(o=>{const c={lat:o.coords.latitude,lng:o.coords.longitude};zn?zn.setPosition(c):zn=new google.maps.Marker({position:c,map:_t,title:"Tu ubicación",icon:{path:google.maps.SymbolPath.CIRCLE,scale:7,fillColor:"#00BFFF",fillOpacity:1,strokeColor:"#ffffff",strokeWeight:2}}),_t.setCenter(c),_t.setZoom(co)},o=>{console.error("Error al obtener ubicación:",o)},{enableHighAccuracy:!0,maximumAge:0,timeout:5e3})):alert("Debes estar dentro de 20 metros de la ruta para iniciar el viaje.")},i=>{console.error("Error al obtener ubicación:",i),alert("No se pudo obtener tu ubicación.")},{enableHighAccuracy:!0,maximumAge:0,timeout:5e3}):alert("Geolocalización no soportada en este navegador.")});document.getElementById("sign-in-google-btn").addEventListener("click",()=>{yu()});document.getElementById("show-user-btn").addEventListener("click",()=>{});
